...
sample_text = '''
  ...
  and its syntax allows programmers to express concepts 
  in fewer lines of code than possible in languages such
  as C++ or Java.
  '''

text_with_prefix = textwrap.indent(sample_text, ">")
